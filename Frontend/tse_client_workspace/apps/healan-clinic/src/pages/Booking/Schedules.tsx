...
import type { BookingDepartmentItem, DoctorSummary, ScheduleTemplateItem } from '../../api/types';
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="تعریف بازه‌های مستقل حضور، دپارتمان هر بازه و ظرفیت بیمه تکمیلی · نسخه dynamic-booking-v1"
      />
