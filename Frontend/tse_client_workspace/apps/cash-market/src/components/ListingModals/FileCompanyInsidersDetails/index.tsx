//API controller: DossierInsiderInformation
//Component name: مشخصات دارندگان اطلاعات نهانی شرکت
...
import {
  ...
  modalConfirmApi,
  modalRejectApi,
  insideryInformationRadioButtonApi,
...
export function DossierFileCompanyInsidersDetailsModal(props: any) {
  ...
  const onAcceptDossierTable = (id: any) => {
    const data = { dossierDataInsiderInformationId: id };
    modalConfirmApi({
      data,
  ...
  const tableHeader: HeaderTypes[] = [
    {
      title: 'مشخصات دارندگان اطلاعات نهانی شرکت ',
      dataIndex: 'insiderInformationTypeName',
      key: 'insiderInformationTypeName',
    },
    {
                  ...
                  <Button
                    ...
                    onClick={() =>
                      onAcceptDossierTable(
                        item?.dossierDataInsiderInformationId
                      )
                    }
    ...
    if (radioValue == 'Form3') {
      if (fileUpload?.fileId && radioValue) {
        const data = {
          ...
          insiderInformationTypeId: radioValue,
        };
        modalSaveApi({
      ...
      if (textAmount && fileUpload?.fileId && radioValue) {
        const data = {
          dossierId,
          submenuId: modalData?.submenuId,
          attachmentId: fileUpload?.fileId,
  ...
  return (
    <ListingModalComponent
      ...
      lastValue={
        ListData?.dossierInsiderInformationInfoResult?.[0]
          ?.insiderInformationTypeName
      }
    >
      <div
        className={` ${
      ...
      >
        ...
        <div className="col-span-12 grid grid-cols-12 gap-4">
          ...
          <Upload
            ...
            name="modalFileCompanyInsiders"
            onDelete={() => onRemoveFile()}
            error={fileUploadError}
          />
          <div className=" 2xl:col-span-6 xl:col-span-4 lg:col-span-12 md:col-span-12  sm:col-span-12  justify-start mx-4">
            <Button
        ...
        <div className="col-span-12 mt-32">
          <SmartTable
            columns={tableHeader}
            data={
              ListData?.dossierInsiderInformationInfoResult?.length > 0
                ? ListData?.dossierInsiderInformationInfoResult
                : []
            }
...
export default withAlert(DossierFileCompanyInsidersDetailsModal);
