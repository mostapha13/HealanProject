...
import type { DashboardStats } from 'apps/cash-market/src/Controller/Healan/types';
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle={`امروز ${convertDateAndTimeToJalali(new Date())}`}
        action={
          <button type="button" className="healan-btn healan-btn--primary" onClick={() => navigate('/healan/appointments')}>
            + پذیرش جدید
          </button>
        }
      />
      ...
      <div className="healan-card">
        <div className="healan-card__header">
          ...
          <button type="button" className="healan-btn healan-btn--outline healan-btn--sm" onClick={() => navigate('/healan/queue')}>
            مشاهده همه
          </button>
        </div>
                ...
                <div key={item.appointmentId} className="healan-queue-item">
                  <div className="healan-queue-item__info">
                    ...
                    <p>
                      ...
                      {convertDateAndTimeToJalali(item.appointmentDate)}
                    </p>
                  </div>
                  <div className="healan-actions">
                    ...
                    <button
                      ...
                      onClick={() => navigate(`/healan/appointments/${item.appointmentId}`)}
                    >
                      جزئیات
                    </button>
                  </div>
