...
import type { PortalBloodPressureItem } from '../api/portalApi';
...
function toSlot(item: PortalBloodPressureItem): BpPeriodSlot {
  return {
...
export function groupBloodPressureByDay(items: PortalBloodPressureItem[]): BpDayRow[] {
