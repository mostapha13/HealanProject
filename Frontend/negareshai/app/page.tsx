...
export default function Home() {
  ...
  async function submit() { if (!file) return setStatus("ابتدا فایل PDF یا Word را انتخاب کنید"); setStatus("در حال آپلود..."); setProgress(0); try { await uploadDocument({ file, title, organizationId: "00000000-0000-0000-0000-000000000001" }, setProgress); setStatus("سند با موفقیت ثبت شد"); } catch (e) { setStatus(e instanceof Error ? e.message : "آپلود انجام نشد"); } }
