...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      ["فیلدها و موارد مهم", "تعریف موارد اختیاری قابل بررسی در گروه‌های سند", "/basic-data/compliance-criteria", "مورد مهم"],
      ["اسناد مورد تأیید", "آپلود و مدیریت منابع معتبر هر گروه", "/basic-data/golden-documents", "مرجع"],
