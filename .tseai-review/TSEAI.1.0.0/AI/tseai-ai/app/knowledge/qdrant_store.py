...
class QdrantKnowledgeStore:
    ...
    async def ensure_collection(self,dimension:int):
        async with httpx.AsyncClient(timeout=20) as c:
            ...
            for field,schema in (("source_type","keyword"),("symbol","keyword"),("category","keyword"),("published_at","datetime"),("metadata.route","keyword"),("metadata.content_type_id","integer"),("metadata.language_id","integer"),("metadata.topics","keyword"),("metadata.companies","keyword"),("metadata.symbols","keyword"),("metadata.is_current","bool")):
                try:
