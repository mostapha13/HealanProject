...
3. Run `scripts/production-e2e.sh` and archive `artifacts/evaluation-live.json`, `artifacts/conversation-evaluation-live.json`, performance results and production acceptance evidence.
