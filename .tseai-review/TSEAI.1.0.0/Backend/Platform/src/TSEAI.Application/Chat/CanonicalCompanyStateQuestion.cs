...
public static class CanonicalCompanyStateQuestion
{
    private static readonly HashSet<string> LookupNoise = new(StringComparer.Ordinal)
    {
        ...
        "نام","اسم","کامل","کلیه","تمام","همه","اعضا","بهم","اطلاعات","مشخصات","فعلی","نمادش","شرکتی","چیست","کیست","چقدر","آن","این","همان","نسبت","فقط","را","رو","بگو","بده","نمایش","کن","کنید","لطفا","لطفاً",
        "سپس","بعد","بعدش","هم","اضافه","اضافهکن","اضافهکنید","دلیلش","علتش","مدیرعاملش","مدیرعاملشون","عاملش","عاملشون","شرکتش","آنشرکت",
    ...
    private static CompanyStateAggregateKind DetectAggregate(string q,HashSet<string> fields,out int? year)
    {
        ...
        if((q.Contains("companystate",StringComparison.Ordinal)&&ContainsAny(q,"کیفیت داده","فیلد خالی","مقادیر خالی","داده ناقص","تکراری"))
            ||ContainsAny(q,"بدون مدیرعامل","فاقد مدیرعامل","بدون هیئت مدیره","فاقد هیئت مدیره","بدون اعضای هیئت مدیره","فاقد اعضای هیئت مدیره","یتیم","قابل اتصال به instrument"))
