...
public static class CanonicalCompanyQuestion
{
    ...
    {
        "شرکت","کمپانی","company","جدول","sql","رکورد","اطلاعات","مشخصات","کامل","فعلی","منبع","ثبت","شده",
    ...
    public static CanonicalCompanyQuestionIntent Parse(string? question)
    {
        ...
        Add("symbol","نماد بورسی شرکت","نماد شرکت","نماد این شرکت","چه نمادی","کدام نماد","کدوم نماد");
