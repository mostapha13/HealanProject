...
public static class PersianMarketQuestionSemantics
{
    ...
    public static IReadOnlyList<string> DetectRequestedFields(string question)
    {
        ...
        Add("effect_on_index","اثر روی شاخص","اثر بر شاخص","روی شاخص اثر","تاثیر روی شاخص","تاثیر بر شاخص");
        ...
        Add("trade_volume","حجم معاملات","حجم دادوستد","حجم آخرین معامله","حجم معامله اش","حجم معامله‌اش","چندتا سهم","چند سهم دست به دست","چند سهم جابه جا","چند سهم جابجا");
