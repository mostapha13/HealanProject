...
export default function App(){
 ...
 return <main className="app">
  ...
  <form onSubmit={ask}><textarea value={q} onChange={e=>setQ(e.target.value)} placeholder="سؤال خود را درباره بورس تهران بنویسید…"/><button disabled={loading}>ارسال</button></form>
 </main>;
}
