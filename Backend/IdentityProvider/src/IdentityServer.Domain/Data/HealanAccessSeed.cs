...
public static class HealanAccessSeed
{
    ...
    private static async Task EnsureFormsAsync(ApplicationDbContext dbContext)
    {
        var forms = new[]
        {
            ...
            new FormDef(HealanAccessFormIds.AccessDefine, "تعریف دسترسی‌ها", "/basic-data/access"),
            new FormDef(HealanAccessFormIds.AccessRoleAssign, "سطح دسترسی نقش‌ها", "/basic-data/access-roles"),
            ...
            new FormDef(HealanAccessFormIds.AccessAdmin, "تعریف نقش", "/basic-data/roles"),
    ...
    private static async Task EnsureMenusAsync(ApplicationDbContext dbContext)
    {
        var menus = new[]
        {
            ...
            new MenuDef(5134, HealanAccessFormIds.BookingSchedules, 5133, 2, "برنامه حضور"),
            new MenuDef(5149, HealanAccessFormIds.BookingDepartments, 5133, 1, "دپارتمان‌ها و خدمات"),
            new MenuDef(5135, HealanAccessFormIds.BookingReservations, 5133, 3, "رزروهای نوبت"),
            ...
            new MenuDef(5115, HealanAccessFormIds.AccessDefine, 5113, 3, "تعریف دسترسی‌ها"),
            new MenuDef(5116, HealanAccessFormIds.AccessRoleAssign, 5113, 4, "سطح دسترسی نقش‌ها"),
            new MenuDef(5120, null, null, 6, "محتوای سایت"),
            ...
            new MenuDef(5144, null, null, 7, "گزارش‌ها"),
            new MenuDef(5117, HealanAccessFormIds.Reports, 5144, 1, "نمودارها و آمارها"),
            new MenuDef(5143, null, null, 8, "مدیریت پیامک"),
            ...
            new MenuDef(5119, HealanAccessFormIds.Signature, null, 9, "امضای دیجیتال"),
            new MenuDef(5118, HealanAccessFormIds.Workflow, null, 10, "کارتابل"),
            new MenuDef(5136, null, null, 11, "ناحیه بیمار (سایت)"),
    ...
    private static async Task EnsureMenuLayoutAsync(ApplicationDbContext dbContext)
    {
        var desired = new Dictionary<int, (int? Parent, int Order, string Title, int? FormId)>
        {
            ...
            [5134] = (5133, 2, "برنامه حضور", HealanAccessFormIds.BookingSchedules),
            [5149] = (5133, 1, "دپارتمان‌ها و خدمات", HealanAccessFormIds.BookingDepartments),
            [5135] = (5133, 3, "رزروهای نوبت", HealanAccessFormIds.BookingReservations),
            ...
            [5115] = (5113, 3, "تعریف دسترسی‌ها", HealanAccessFormIds.AccessDefine),
            [5116] = (5113, 4, "سطح دسترسی نقش‌ها", HealanAccessFormIds.AccessRoleAssign),
            [5120] = (null, 6, "محتوای سایت", null),
            ...
            [5144] = (null, 7, "گزارش‌ها", null),
            [5117] = (5144, 1, "نمودارها و آمارها", HealanAccessFormIds.Reports),
            [5143] = (null, 8, "مدیریت پیامک", null),
            [5129] = (5143, 1, "پیامک‌های ارسالی", HealanAccessFormIds.SmsOutbox),
            [5130] = (5143, 2, "تنظیمات پیامک", HealanAccessFormIds.SmsSettings),
            [5119] = (null, 9, "امضای دیجیتال", HealanAccessFormIds.Signature),
            [5118] = (null, 10, "کارتابل", HealanAccessFormIds.Workflow),
            [5136] = (null, 11, "ناحیه بیمار (سایت)", null),
