...
{
    public class GetUserCardboardQuery : AbstractSearchRequest<PaginatedList<UserCardboardResponse>>
    {
    ...
    public class GetCardboardQueryHandler : IRequestHandler<GetUserCardboardQuery, PaginatedList<UserCardboardResponse>>
    {
        ...
        public async Task<PaginatedList<UserCardboardResponse>> Handle(GetUserCardboardQuery request, CancellationToken cancellationToken)
        {
            return new PaginatedList<UserCardboardResponse>();
