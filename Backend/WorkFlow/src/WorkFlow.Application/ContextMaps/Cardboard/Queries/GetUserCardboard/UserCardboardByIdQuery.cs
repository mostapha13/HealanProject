...
{
    public class UserCardboardByIdQuery : IRequest<List<UserCardboardResponse>>
    {
        public Guid? UserId { get; set; }
        public List<string> OrderIds { get; set; }
    }
    public class UserCardboardByIdQueryHandler : IRequestHandler<UserCardboardByIdQuery, List<UserCardboardResponse>>
    {
        private readonly IApplicationDbContext _applicationDbContext;
        private readonly IMapper _mapper;
        private readonly ICurrentUserService _currentUserService;

        public UserCardboardByIdQueryHandler(IApplicationDbContext applicationDbContext, IMapper mapper, ICurrentUserService currentUserService)
        {
            _applicationDbContext = applicationDbContext;
            _mapper = mapper;
            _currentUserService = currentUserService;
        }
        public async Task<List<UserCardboardResponse>> Handle(UserCardboardByIdQuery request, CancellationToken cancellationToken)
        {
