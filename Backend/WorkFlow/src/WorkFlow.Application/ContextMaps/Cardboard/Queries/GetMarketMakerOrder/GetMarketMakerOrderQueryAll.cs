...
{
    public class GetWorkFlowOrderQueryAll : AbstractRequestBase<List<WorkFlowOrderResponse>>
    {
    ...
    public class GetWorkFlowOrderQueryAllHandler : IRequestHandler<GetWorkFlowOrderQueryAll, List<WorkFlowOrderResponse>>
    {
        private readonly IApplicationDbContext _applicationDbContext;
        private readonly IMapper _mapper;
        private readonly ICurrentUserService _currentUserService;

        public GetWorkFlowOrderQueryAllHandler(IApplicationDbContext applicationDbContext, IMapper mapper, ICurrentUserService currentUserService)
        {
            _applicationDbContext = applicationDbContext;
            _mapper = mapper;
            _currentUserService = currentUserService;
        }
        public async Task<List<WorkFlowOrderResponse>> Handle(GetWorkFlowOrderQueryAll request, CancellationToken cancellationToken)
        {
            ...
            var query = from wfg in _applicationDbContext.WorkFlowGuides
                        ...
                        join order in _applicationDbContext.Orders.Include(a => a.OrderChilds) on wfa.OrderId equals order.OrderId
                        ...
                        wfg.Weight == WeightId.Next &&
                        wft.WorkFlowTypeId != WorkFlowTypeId.MarketMakerQuitOrderRequest &&
                        wft.WorkFlowTypeId != WorkFlowTypeId.MarketMakerAccessRequest &&
                        receiverGroup.WorkFlowUserGroupId == WorkFlowUserGroupId.MarketMaker &&
                        currenUser.WorkFlowUserGroupId ==WorkFlowUserGroupId.MarketMaker &&
                       !order.IsDeleted &&
                        (
                        ...
                        select new WorkFlowOrderResponse
                        {
                            ...
                            CanExtendOrCancel = currenUser.WorkFlowUserGroupId == WorkFlowUserGroupId.MarketMaker && !order.OrderChilds.Any(),
