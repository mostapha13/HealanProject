...
{
    public class GetWorkFlowOrderQuery : AbstractSearchRequest<PaginatedList<WorkFlowOrderResponse>>
    {
    ...
    public class GetUserArchivesQueryHandler : IRequestHandler<GetWorkFlowOrderQuery, PaginatedList<WorkFlowOrderResponse>>
    {
        ...
        public async Task<PaginatedList<WorkFlowOrderResponse>> Handle(GetWorkFlowOrderQuery request, CancellationToken cancellationToken)
        {
            ...
            var result = await query.Distinct().PaginatedListAsync(request.PageNumber, request.PageSize, cancellationToken);
            return result;
        }
    }
