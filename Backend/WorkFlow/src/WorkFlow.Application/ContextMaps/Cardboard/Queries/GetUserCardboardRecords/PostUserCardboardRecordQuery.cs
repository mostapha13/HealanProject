...
{
    public class PostUserCardboardRecordQuery : AbstractSearchRequest<PaginatedList<UserCardboardRecordResponse>>
    {
    ...
    public class PostCardboardRecordQueryHandler : IRequestHandler<PostUserCardboardRecordQuery, PaginatedList<UserCardboardRecordResponse>>
    {
        private readonly IApplicationDbContext _applicationDbContext;
        private readonly IMapper _mapper;
        private readonly ICurrentUserService _currentUserService;

        public PostCardboardRecordQueryHandler(IApplicationDbContext applicationDbContext, IMapper mapper, ICurrentUserService currentUserService)
        {
            _applicationDbContext = applicationDbContext;
            _mapper = mapper;
            _currentUserService = currentUserService;
        }
        public async Task<PaginatedList<UserCardboardRecordResponse>> Handle(PostUserCardboardRecordQuery request, CancellationToken cancellationToken)
        {
