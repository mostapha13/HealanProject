...
{
    public class GetUserCardboardRecordQuery : AbstractSearchRequest<PaginatedList<UserCardboardRecordResponse>>
    {
    ...
    public class GetCardboardRecordQueryHandler : IRequestHandler<GetUserCardboardRecordQuery, PaginatedList<UserCardboardRecordResponse>>
    {
        private readonly IApplicationDbContext _applicationDbContext;
        private readonly IMapper _mapper;
        private readonly ICurrentUserService _currentUserService;

        public GetCardboardRecordQueryHandler(IApplicationDbContext applicationDbContext, IMapper mapper, ICurrentUserService currentUserService)
        {
            _applicationDbContext = applicationDbContext;
            _mapper = mapper;
            _currentUserService = currentUserService;
        }
        public async Task<PaginatedList<UserCardboardRecordResponse>> Handle(GetUserCardboardRecordQuery request, CancellationToken cancellationToken)
        {
