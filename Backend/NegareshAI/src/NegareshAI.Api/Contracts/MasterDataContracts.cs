...
public sealed record ApprovedContractClauseResponse(Guid Id, Guid ContractGroupId, string GroupName,
    string Code, string Title, string Text, int Order, bool IsRequired, bool IsActive);
public sealed record SaveApprovedContractClauseRequest(Guid ContractGroupId, string Code,
    string Title, string Text, int Order, bool IsRequired, bool IsActive = true);
